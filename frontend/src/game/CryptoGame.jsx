...
const levels = [
  { id: 1, title: 'Level 1: Caesar Cipher', description: 'The ancient substitution cipher.', question: 'If a Caesar cipher has a shift of +3, what does "A" become?', options: ['B', 'C', 'D', 'E'], answer: 2 },
  { id: 2, title: 'Level 2: Vigenère Cipher', description: 'The polyalphabetic cipher.', question: 'What does the Vigenère cipher use to shift letters dynamically?', spread: false, options: ['A constant number', 'A keyword', 'Prime numbers', 'A matrix'], answer: 1 },
  { id: 3, title: 'Level 3: RSA Encryption', description: 'Modern public-key cryptography.', question: 'RSA relies on the mathematical difficulty of factoring which of the following?', options: ['Large prime numbers', 'Large composite numbers', 'Matrices', 'Polynomials'], answer: 1 }
];
  ...
  return (
    <div className="w-full min-h-screen bg-slate-900 font-sans text-slate-100 p-8 flex flex-col items-center">
      ...
      {!activeQuiz ? (
        ...
        <div className="w-full max-w-3xl bg-slate-800 border-2 border-yellow-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex items-center justify-between border-t border-slate-700 pt-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button 
                ...
                className="px-8 py-3 rounded-xl font-bold bg-yellow-500 hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-colors shadow-lg shadow-yellow-500/30"
              >
                Submit Answer
              </button>
            </div>
