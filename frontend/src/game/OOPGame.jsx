...
const levels = [
  { id: 1, title: 'Level 1: Classes & Objects', description: 'The blueprints of OOP.' },
  { id: 2, title: 'Level 2: Inheritance', description: 'Passing traits to children.' },
  { id: 3, title: 'Level 3: Polymorphism', description: 'Many forms of the same method.' }
];
